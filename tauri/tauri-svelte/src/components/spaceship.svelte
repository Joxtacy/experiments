...
Command: npx @threlte/gltf@2.0.1 C:\Users\Utente\Desktop\Trasferimento-PC\Projects\Youtube\Threlte\spaceship-header\static\models\spaceship.glb --root /models/ --printwidth 120 --precision 2
	...
	{:then gltf}
		...
		>
			...
			<T.Mesh
				castShadow
				receiveShadow
				geometry={gltf.nodes.Cube001_RPanel003_RExtr001_spaceship_racer_0
					.geometry}
				material={gltf.materials.spaceship_racer}
				position={[739.26, 0, 0]}
			/>
			...
			{#await map then mapValue}
				<T.Mesh position={[740, -60, -1350]} rotation.x={Math.PI / 2}>
